...
export const Experiences: {
  ...
  Busitema: {
    ...
    roles: [
      ...
      'Run lab sessions on SQL queries, database design, and the basics of operating systems and systems programming.',
      'Supervise final-year projects and research, reviewing student code and technical write-ups.',
      'Write lecture notes, practical materials and assessments, and set, invigilate and mark coursework and exams.',
  ...
  Dreamr: {
    ...
    roles: [
      ...
      'Fixed and tuned existing automations so they ran faster and broke less often.',
  ...
  NCBS: {
    ...
    longName: 'Nile Center Business Support (NCBS)',
    subDetail: 'via Remote',
    url: 'https://ncbs.io/',
    ...
    roles: [
      'Traineeship for Remote work, providing IT support and development of the company website.',
      'Joined different courses for soft skills, problem solving and critical thinking.',
      'Worked on maintaining the NCBS main site, developed with WordPress.',
